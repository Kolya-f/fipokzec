const codeSamples = [
    { 
        ...
        lines: [
            ...
            '    <span style="color:#fbbf24">&lt;title&gt;</span><span style="color:#38bdf8">Сучасний сайт</span><span style="color:#fbbf24">&lt;/title&gt;</span>',
    ...
    { 
        ...
        lines: [
            ...
            '        <span style="color:#c084fc">const</span> { <span style="color:#4ade80">data</span> } = <span style="color:#c084fc">await</span> <span style="color:#38bdf8">axios</span>.<span style="color:#fbbf24">get</span>&lt;<span style="color:#38bdf8">Project</span>[]&gt;(<span style="color:#4ade80">\'/api/projects\'</span>);',
            '        <span style="color:#38bdf8">setProjects</span>(<span style="color:#4ade80">data</span>);',
            '      } <span style="color:#c084fc">catch</span> (<span style="color:#4ade80">error</span>) {',
            '        <span style="color:#38bdf8">console</span>.<span style="color:#fbbf24">error</span>(<span style="color:#4ade80">\'Error fetching projects:\'</span>, <span style="color:#4ade80">error</span>);',
    ...
    { 
        ...
        lines: [
            ...
            '};',
            '',
            '<span style="color:#c084fc">const</span> <span style="color:#38bdf8">animateOnScroll</span> = <span style="color:#fbbf24">()</span> => {',
            ...
            '  ',
            '  <span style="color:#c084fc">const</span> <span style="color:#38bdf8">observer</span> = <span style="color:#c084fc">new</span> <span style="color:#38bdf8">IntersectionObserver</span>(<span style="color:#fbbf24">(entries)</span> => {',
            ...
            '        <span style="color:#38bdf8">observer</span>.<span style="color:#fbbf24">unobserve</span>(entry.<span style="color:#4ade80">target</span>);',
            '      }',
            '    });',
            '  }, <span style="color:#38bdf8">observerOptions</span>);',
            '  ',
            '  elements.<span style="color:#fbbf24">forEach</span>(el => <span style="color:#38bdf8">observer</span>.<span style="color:#fbbf24">observe</span>(el));',
            '};',
            '',
            '<span style="color:#38bdf8">document</span>.<span style="color:#fbbf24">addEventListener</span>(<span style="color:#4ade80">\'DOMContentLoaded\'</span>, <span style="color:#38bdf8">animateOnScroll</span>);'
        ] 
    },
    { 
