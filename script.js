const codeSamples = [
    { 
        ...
        lines: [
            ...
            '<span style="color:#fbbf24">&lt;html</span> <span style="color:#4ade80">lang</span>=<span style="color:#fbbf24">"uk"</span><span style="color:#fbbf24">&gt;</span>',
            '  <span style="color:#fbbf24">&lt;head&gt;</span>',
            '    <span style="color:#fbbf24">&lt;meta</span> <span style="color:#4ade80">charset</span>=<span style="color:#fbbf24">"UTF-8"</span><span style="color:#fbbf24">&gt;</span>',
            '    <span style="color:#fbbf24">&lt;meta</span> <span style="color:#4ade80">name</span>=<span style="color:#fbbf24">"viewport"</span> <span style="color:#4ade80">content</span>=<span style="color:#fbbf24">"width=device-width, initial-scale=1.0"</span><span style="color:#fbbf24">&gt;</span>',
            '    <span style="color:#fbbf24">&lt;title&gt;</span><span style="color:#38bdf8">fipokzec.dev</span><span style="color:#fbbf24">&lt;/title&gt;</span>',
            '    <span style="color:#fbbf24">&lt;link</span> <span style="color:#4ade80">rel</span>=<span style="color:#fbbf24">"stylesheet"</span> <span style="color:#4ade80">href</span>=<span style="color:#fbbf24">"style.css"</span><span style="color:#fbbf24">&gt;</span>',
            '  <span style="color:#fbbf24">&lt;/head&gt;</span>',
            '  <span style="color:#fbbf24">&lt;body&gt;</span>',
            '    <span style="color:#fbbf24">&lt;header&gt;</span>',
            '      <span style="color:#fbbf24">&lt;nav&gt;</span>',
            '        <span style="color:#fbbf24">&lt;div</span> <span style="color:#4ade80">class</span>=<span style="color:#fbbf24">"logo"</span><span style="color:#fbbf24">&gt;</span><span style="color:#38bdf8">fipokzec.dev</span><span style="color:#fbbf24">&lt;/div&gt;</span>',
            '      <span style="color:#fbbf24">&lt;/nav&gt;</span>',
            '    <span style="color:#fbbf24">&lt;/header&gt;</span>',
            '  <span style="color:#fbbf24">&lt;/body&gt;</span>',
    ...
    { 
        title: "developer@fipokzec:~/styles.css", 
        lines: [
            '<span style="color:#c084fc">@import</span> <span style="color:#fbbf24">url</span>(<span style="color:#4ade80">\'https://fonts.googleapis.com/css2?family=Inter:wght@400;700&display=swap\'</span>);',
            '',
            '<span style="color:#c084fc">:root</span> {',
            '  <span style="color:#4ade80">--primary</span>: <span style="color:#38bdf8">#7F77DD</span>;',
            '  <span style="color:#4ade80">--dark</span>: <span style="color:#38bdf8">#0a0a0f</span>;',
            '  <span style="color:#4ade80">--light</span>: <span style="color:#38bdf8">#e2e8f0</span>;',
            '  <span style="color:#4ade80">--transition</span>: <span style="color:#38bdf8">0.3s ease</span>;',
            '}',
            '',
            '<span style="color:#fbbf24">*</span> {',
            '  <span style="color:#4ade80">margin</span>: <span style="color:#38bdf8">0</span>;',
            '  <span style="color:#4ade80">padding</span>: <span style="color:#38bdf8">0</span>;',
            '  <span style="color:#4ade80">box-sizing</span>: <span style="color:#fbbf24">border-box</span>;',
            '}',
            '',
            '<span style="color:#fbbf24">body</span> {',
            '  <span style="color:#4ade80">font-family</span>: <span style="color:#fbbf24">\'Inter\'</span>, sans-serif;',
            '  <span style="color:#4ade80">background</span>: <span style="color:#c084fc">var</span>(<span style="color:#4ade80">--dark</span>);',
            '  <span style="color:#4ade80">color</span>: <span style="color:#c084fc">var</span>(<span style="color:#4ade80">--light</span>);',
            '  <span style="color:#4ade80">line-height</span>: <span style="color:#38bdf8">1.6</span>;',
            '}',
            '',
            '<span style="color:#fbbf24">.container</span> {',
            '  <span style="color:#4ade80">max-width</span>: <span style="color:#38bdf8">1200px</span>;',
            '  <span style="color:#4ade80">margin</span>: <span style="color:#38bdf8">0 auto</span>;',
            '  <span style="color:#4ade80">padding</span>: <span style="color:#38bdf8">0 20px</span>;',
            '}',
            '',
            '<span style="color:#fbbf24">.btn</span> {',
            '  <span style="color:#4ade80">display</span>: <span style="color:#fbbf24">inline-block</span>;',
            '  <span style="color:#4ade80">padding</span>: <span style="color:#38bdf8">12px 28px</span>;',
            '  <span style="color:#4ade80">background</span>: <span style="color:#c084fc">linear-gradient</span>(<span style="color:#38bdf8">135deg</span>, <span style="color:#c084fc">var</span>(<span style="color:#4ade80">--primary</span>), <span style="color:#38bdf8">#9f97ff</span>);',
            '  <span style="color:#4ade80">border-radius</span>: <span style="color:#38bdf8">40px</span>;',
            '  <span style="color:#4ade80">color</span>: <span style="color:#38bdf8">white</span>;',
            '  <span style="color:#4ade80">transition</span>: <span style="color:#c084fc">var</span>(<span style="color:#4ade80">--transition</span>);',
            '}',
            '',
            '<span style="color:#fbbf24">.btn</span><span style="color:#c084fc">:hover</span> {',
            '  <span style="color:#4ade80">transform</span>: <span style="color:#38bdf8">translateY(-3px)</span>;',
            '  <span style="color:#4ade80">box-shadow</span>: <span style="color:#38bdf8">0 10px 20px rgba(127,119,221,0.3)</span>;',
            '}'
        ] 
    },
    { 
        ...
        lines: [
            '<span style="color:#c084fc">import</span> <span style="color:#38bdf8">React</span>, { <span style="color:#38bdf8">useState</span>, <span style="color:#38bdf8">useEffect</span> } <span style="color:#c084fc">from</span> <span style="color:#4ade80">\'react\'</span>;',
            '<span style="color:#c084fc">import</span> <span style="color:#38bdf8">axios</span> <span style="color:#c084fc">from</span> <span style="color:#4ade80">\'axios\'</span>;',
            '',
            '<span style="color:#c084fc">interface</span> <span style="color:#38bdf8">Project</span> {',
            '  <span style="color:#4ade80">id</span>: <span style="color:#38bdf8">number</span>;',
            '  <span style="color:#4ade80">title</span>: <span style="color:#38bdf8">string</span>;',
            '  <span style="color:#4ade80">description</span>: <span style="color:#38bdf8">string</span>;',
            '}',
            '',
            '<span style="color:#c084fc">const</span> <span style="color:#38bdf8">App</span>: <span style="color:#38bdf8">React</span>.<span style="color:#38bdf8">FC</span> = () => {',
            '  <span style="color:#c084fc">const</span> [<span style="color:#38bdf8">projects</span>, <span style="color:#38bdf8">setProjects</span>] = <span style="color:#38bdf8">useState</span>&lt;<span style="color:#38bdf8">Project</span>[]&gt;([]);',
            '  <span style="color:#c084fc">const</span> [<span style="color:#38bdf8">loading</span>, <span style="color:#38bdf8">setLoading</span>] = <span style="color:#38bdf8">useState</span>&lt;<span style="color:#38bdf8">boolean</span>&gt;(<span style="color:#c084fc">true</span>);',
            '',
            '  <span style="color:#38bdf8">useEffect</span>(() => {',
            '    <span style="color:#c084fc">const</span> <span style="color:#38bdf8">fetchProjects</span> = <span style="color:#c084fc">async</span> () => {',
            '      <span style="color:#c084fc">try</span> {',
            '        <span style="color:#c084fc">const</span> response = <span style="color:#c084fc">await</span> <span style="color:#38bdf8">axios</span>.<span style="color:#fbbf24">get</span>&lt;<span style="color:#38bdf8">Project</span>[]&gt;(<span style="color:#4ade80">\'/api/projects\'</span>);',
            '        <span style="color:#38bdf8">setProjects</span>(response.<span style="color:#4ade80">data</span>);',
            '      } <span style="color:#c084fc">catch</span> (error) {',
            '        <span style="color:#38bdf8">console</span>.<span style="color:#fbbf24">error</span>(<span style="color:#4ade80">\'Error:\'</span>, error);',
            '      } <span style="color:#c084fc">finally</span> {',
            '        <span style="color:#38bdf8">setLoading</span>(<span style="color:#c084fc">false</span>);',
            '      }',
            '    };',
            '    <span style="color:#38bdf8">fetchProjects</span>();',
            '  }, []);',
            '',
            '  <span style="color:#c084fc">if</span> (<span style="color:#38bdf8">loading</span>) <span style="color:#c084fc">return</span> <span style="color:#fbbf24">&lt;div&gt;</span><span style="color:#38bdf8">Loading...</span><span style="color:#fbbf24">&lt;/div&gt;</span>;',
            '  <span style="color:#c084fc">return</span> <span style="color:#fbbf24">&lt;div&gt;</span><span style="color:#fbbf24">&lt;h1&gt;</span><span style="color:#38bdf8">Projects</span><span style="color:#fbbf24">&lt;/h1&gt;</span><span style="color:#fbbf24">&lt;/div&gt;</span>;',
            '};',
            '',
            '<span style="color:#c084fc">export</span> <span style="color:#c084fc">default</span> <span style="color:#38bdf8">App</span>;'
        ] 
    },
    { 
        title: "developer@fipokzec:~/animation.js", 
        lines: [
            '<span style="color:#c084fc">const</span> <span style="color:#38bdf8">observerOptions</span> = {',
            '  <span style="color:#4ade80">threshold</span>: <span style="color:#38bdf8">0.2</span>,',
            '  <span style="color:#4ade80">rootMargin</span>: <span style="color:#fbbf24">\'0px 0px -50px 0px\'</span>',
            '};',
            '',
            '<span style="color:#c084fc">const</span> <span style="color:#38bdf8">animateOnScroll</span> = () => {',
            '  <span style="color:#c084fc">const</span> elements = <span style="color:#38bdf8">document</span>.<span style="color:#fbbf24">querySelectorAll</span>(<span style="color:#4ade80">\'.animate\'</span>);',
            '  ',
            '  <span style="color:#c084fc">const</span> observer = <span style="color:#c084fc">new</span> <span style="color:#38bdf8">IntersectionObserver</span>((entries) => {',
            '    entries.<span style="color:#fbbf24">forEach</span>(entry => {',
            '      <span style="color:#c084fc">if</span> (entry.<span style="color:#4ade80">isIntersecting</span>) {',
            '        entry.<span style="color:#4ade80">target</span>.<span style="color:#fbbf24">classList</span>.<span style="color:#fbbf24">add</span>(<span style="color:#4ade80">\'visible\'</span>);',
            '        observer.<span style="color:#fbbf24">unobserve</span>(entry.<span style="color:#4ade80">target</span>);',
            '      }',
            '    });',
            '  }, observerOptions);',
            '  ',
            '  elements.<span style="color:#fbbf24">forEach</span>(el => observer.<span style="color:#fbbf24">observe</span>(el));',
            '};',
            '',
            '<span style="color:#38bdf8">document</span>.<span style="color:#fbbf24">addEventListener</span>(<span style="color:#4ade80">\'DOMContentLoaded\'</span>, animateOnScroll);'
        ] 
    },
    { 
        title: "developer@fipokzec:~/git-commands", 
        lines: [
            '<span style="color:#4ade80">$</span> <span style="color:#fbbf24">git init</span>',
            '<span style="color:#4ade80">$</span> <span style="color:#fbbf24">git add .</span>',
            '<span style="color:#4ade80">$</span> <span style="color:#fbbf24">git commit -m</span> <span style="color:#38bdf8">"Initial commit"</span>',
            '<span style="color:#4ade80">$</span> <span style="color:#fbbf24">git branch -M main</span>',
            '<span style="color:#4ade80">$</span> <span style="color:#fbbf24">git remote add origin</span> <span style="color:#38bdf8">https://github.com/user/repo.git</span>',
            '<span style="color:#4ade80">$</span> <span style="color:#fbbf24">git push -u origin main</span>',
            '',
            '<span style="color:#4ade80">$</span> <span style="color:#fbbf24">git checkout -b feature/new-component</span>',
            '<span style="color:#4ade80">$</span> <span style="color:#fbbf24">git add .</span>',
            '<span style="color:#4ade80">$</span> <span style="color:#fbbf24">git commit -m</span> <span style="color:#38bdf8">"Add new component"</span>',
            '<span style="color:#4ade80">$</span> <span style="color:#fbbf24">git push origin feature/new-component</span>',
            '',
            '<span style="color:#4ade80">$</span> <span style="color:#fbbf24">git checkout main</span>',
            '<span style="color:#4ade80">$</span> <span style="color:#fbbf24">git pull origin main</span>',
            '<span style="color:#4ade80">$</span> <span style="color:#fbbf24">git merge feature/new-component</span>',
            '',
            '<span style="color:#4ade80">✓</span> <span style="color:#38bdf8">Successfully merged!</span>'
        ] 
    },
    { 
        title: "developer@fipokzec:~/responsive-design", 
        lines: [
            '<span style="color:#c084fc">/* Mobile First Approach */</span>',
            '',
            '<span style="color:#fbbf24">.hero-grid</span> {',
            '  <span style="color:#4ade80">display</span>: flex;',
            '  <span style="color:#4ade80">flex-direction</span>: column;',
            '  <span style="color:#4ade80">gap</span>: <span style="color:#38bdf8">32px</span>;',
            '  <span style="color:#4ade80">padding</span>: <span style="color:#38bdf8">40px 20px</span>;',
            '}',
            '',
            '<span style="color:#c084fc">/* Tablet */</span>',
            '<span style="color:#c084fc">@media</span> <span style="color:#fbbf24">(min-width: 768px)</span> {',
            '  <span style="color:#fbbf24">.hero-grid</span> {',
            '    <span style="color:#4ade80">flex-direction</span>: row;',
            '    <span style="color:#4ade80">gap</span>: <span style="color:#38bdf8">48px</span>;',
            '  }',
            '  <span style="color:#fbbf24">.section-title</span> {',
            '    <span style="color:#4ade80">font-size</span>: <span style="color:#38bdf8">2.5rem</span>;',
            '  }',
            '}',
            '',
            '<span style="color:#c084fc">/* Desktop */</span>',
            '<span style="color:#c084fc">@media</span> <span style="color:#fbbf24">(min-width: 1024px)</span> {',
            '  <span style="color:#fbbf24">.hero-grid</span> {',
            '    <span style="color:#4ade80">gap</span>: <span style="color:#38bdf8">80px</span>;',
            '  }',
            '  <span style="color:#fbbf24">.section-title</span> {',
            '    <span style="color:#4ade80">font-size</span>: <span style="color:#38bdf8">3rem</span>;',
            '  }',
            '}',
            '',
            '<span style="color:#c084fc">/* Hover Effects */</span>',
            '<span style="color:#fbbf24">.btn</span><span style="color:#c084fc">:hover</span> {',
            '  <span style="color:#4ade80">transform</span>: <span style="color:#38bdf8">translateY(-3px)</span>;',
            '  <span style="color:#4ade80">box-shadow</span>: <span style="color:#38bdf8">0 10px 20px rgba(127,119,221,0.3)</span>;',
            '}'
    ...
    { 
        title: "developer@fipokzec:~/typescript", 
        lines: [
            '<span style="color:#c084fc">interface</span> <span style="color:#38bdf8">User</span> {',
            '  <span style="color:#4ade80">id</span>: <span style="color:#38bdf8">number</span>;',
            '  <span style="color:#4ade80">name</span>: <span style="color:#38bdf8">string</span>;',
            '  <span style="color:#4ade80">email</span>: <span style="color:#38bdf8">string</span>;',
            '  <span style="color:#4ade80">isActive</span>: <span style="color:#38bdf8">boolean</span>;',
            '}',
            '',
            '<span style="color:#c084fc">type</span> <span style="color:#38bdf8">ApiResponse</span>&lt;T&gt; = {',
            '  <span style="color:#4ade80">data</span>: T;',
            '  <span style="color:#4ade80">status</span>: <span style="color:#38bdf8">number</span>;',
            '  <span style="color:#4ade80">message</span>: <span style="color:#38bdf8">string</span>;',
            '};',
            '',
            '<span style="color:#c084fc">const</span> <span style="color:#38bdf8">fetchUser</span> = <span style="color:#c084fc">async</span> (id: <span style="color:#38bdf8">number</span>): <span style="color:#38bdf8">Promise</span>&lt;<span style="color:#38bdf8">ApiResponse</span>&lt;<span style="color:#38bdf8">User</span>&gt;&gt; => {',
            '  <span style="color:#c084fc">const</span> response = <span style="color:#c084fc">await</span> <span style="color:#38bdf8">fetch</span>(<span style="color:#4ade80">`/api/users/${id}`</span>);',
            '  <span style="color:#c084fc">return</span> response.<span style="color:#38bdf8">json</span>();',
            '};'
        ] 
    },
    { 
        title: "developer@fipokzec:~/wordpress-plugin.php", 
        lines: [
            '<span style="color:#c084fc">&lt;?php</span>',
            '<span style="color:#c084fc">/**',
            ' * Plugin Name: fipokzec Custom Plugin',
            ' * Version: 1.0.0',
            ' */</span>',
            '',
            '<span style="color:#c084fc">if</span> ( ! <span style="color:#38bdf8">defined</span>( <span style="color:#4ade80">\'ABSPATH\'</span> ) ) {',
            '    <span style="color:#c084fc">exit;</span>',
            '}',
            '',
            '<span style="color:#c084fc">function</span> <span style="color:#38bdf8">fipokzec_register_shortcode</span>() {',
            '    <span style="color:#38bdf8">add_shortcode</span>( <span style="color:#4ade80">\'fipokzec_portfolio\'</span>, <span style="color:#4ade80">\'fipokzec_portfolio_shortcode\'</span> );',
            '}',
            '<span style="color:#38bdf8">add_action</span>( <span style="color:#4ade80">\'init\'</span>, <span style="color:#4ade80">\'fipokzec_register_shortcode\'</span> );',
            '',
            '<span style="color:#c084fc">function</span> <span style="color:#38bdf8">fipokzec_portfolio_shortcode</span>() {',
            '    <span style="color:#c084fc">return</span> <span style="color:#4ade80">\'&lt;div class="fipokzec-portfolio"&gt;My Portfolio&lt;/div&gt;\'</span>;',
            '}'
        ] 
    }
];
